      ...
      <main className="flex-1 px-4 md:px-6 pt-4 pb-28 space-y-5 w-full">
        ...
        <Tabs defaultValue="program" className="w-full">
          <TabsList className="w-full grid grid-cols-3 bg-primary px-1 py-0 rounded-xl mb-4 gap-1">
            ...
            <TabsTrigger value="personal" className="text-[11px] py-2 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]: font-bold transition-all rounded-full text-primary-foreground shadow-lg/30">
              Personal
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="program" className="space-y-4">
            <Sheet>
              <SheetTrigger className="inline-flex items-center justify-center rounded-xl text-xs font-bold transition-colors w-full bg-card border border-border text-foreground h-10 px-4 hover:bg-muted shadow-lg/30">
            ...
            <div className="space-y-3">
              {filteredPrograms.length > 0 ? filteredPrograms.map((prog) => (
                <Card key={prog.id} onClick={() => router.push(`/coach/training/${prog.id}?type=${prog.type}`)} className="border border-border cursor-pointer hover:border-primary/50 bg-card rounded-2xl shadow-lg/30">
          ...
          <TabsContent value="time-trial" className="space-y-4">
            <Button
              ...
              className="w-full bg-primary hover:bg-primary/90 h-12 text-sm font-bold rounded-xl text-primary-foreground uppercase tracking-widest shadow-lg/30"
            >
            ...
            <div className="space-y-3">
              ...
              {timeTrials.map(tt => (
                <Card key={tt.id} onClick={() => router.push(`/coach/training/time-trial/${tt.id}`)} className="border border-border cursor-pointer hover:border-primary/50 bg-card rounded-2xl shadow-lg/30">
          ...
          <TabsContent value="personal" className="space-y-4">
            <div className="space-y-4">
              {personals.map(prog => {
                ...
                return (
                  <Card key={prog.id} className="border border-border bg-card rounded-2xl shadow-lg/30">
      ...
      <Sheet open={isAssignSheetOpen} onOpenChange={setIsAssignSheetOpen}>
        <SheetContent side="bottom" className="rounded-t-3xl px-4 pb-6 pt-4 h-[75vh] flex flex-col bg-card border-t border-border">
          ...
          <div className="pt-4 border-t border-border shrink-0">
            <Button onClick={handleSaveAssign} className="w-full bg-primary hover:bg-primary/90 h-12 text-sm font-bold rounded-xl uppercase tracking-widest text-primary-foreground shadow-lg/30">
      ...
      <Sheet open={isTimeTrialSheetOpen} onOpenChange={setIsTimeTrialSheetOpen}>
        <SheetContent side="bottom" className="rounded-t-3xl px-4 pb-6 pt-4 h-auto flex flex-col bg-card border-t border-border">
          ...
          <div className="pt-4 border-t border-border mt-4 shrink-0">
            <Button onClick={handleCreateTimeTrial} className="w-full bg-primary hover:bg-primary/90 h-12 text-sm font-bold rounded-xl uppercase tracking-widest text-primary-foreground shadow-lg/30">
