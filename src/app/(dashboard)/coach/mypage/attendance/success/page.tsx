...
function AttendanceSuccessContent() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full items-center justify-center p-6 text-center">
      ...
      <div className="bg-card border border-border p-6 rounded-3xl w-full max-w-sm mb-10 relative overflow-hidden shadow-lg/30">
      ...
      <Button 
        ...
        className="w-full max-w-sm h-14 rounded-2xl font-bold text-lg bg-primary hover:bg-primary/90 text-primary-foreground -primary/25 uppercase tracking-widest shadow-lg/30"
      >
