  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full" suppressHydrationWarning>
      ...
      <main className="flex-1 overflow-y-auto w-full p-4 pb-12">
        ...
        {/* Profile Card */}
        <div className="bg-card rounded-3xl p-6 shadow-sm border border-border mb-4 flex flex-col items-center text-center relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-24 bg-primary/20"></div>
          
          <Avatar className="h-24 w-24 ring-4 ring-card shadow-lg mb-4 relative z-10">
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <div className="bg-card p-3 rounded-2xl border border-border shadow-sm flex flex-col items-center justify-center text-center">
