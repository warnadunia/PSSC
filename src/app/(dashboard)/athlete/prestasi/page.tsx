...
const historyProgramDetailed = [
  { 
    ...
    groups: [
      ...
      { name: "MAIN SET", drills: [{ id: 103, name: "4 × 100 Free", target: "@ 1:50", isDone: false, color: "bg-red-600" }, { id: 104, name: "4 × 50 Stroke", target: "@ 1:00", isDone: false, color: "bg-pink-500" }] }
    ]
  },
  {
    id: 2, session: "Sprint Endurance 🔥", timeAgo: "2 days ago", distance: "800 m", duration: "30 min",
    groups: [
      { name: "MAIN SET", drills: [{ id: 201, name: "8 × 100 Freestyle", target: "@ 1:15", isDone: true, color: "bg-red-600" }] }
    ]
  }
]
    ...
    <div className="flex flex-col min-h-[100dvh] w-full pb-20">
      ...
      <div className="px-4">
        <Tabs defaultValue="program" className="w-full">
          <TabsList className="w-full grid grid-cols-3 mb-4 bg-slate-200/50 p-1 rounded-xl">
            <TabsTrigger value="program" className="rounded-lg text-[11px] font-bold data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:shadow-sm">
              Program
            </TabsTrigger>
            <TabsTrigger value="time-trial" className="rounded-lg text-[11px] font-bold data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:shadow-sm">
              Time Trial
            </TabsTrigger>
            <TabsTrigger value="kejuaraan" className="rounded-lg text-[11px] font-bold data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:shadow-sm">
              Kejuaraan
            </TabsTrigger>
          </TabsList>
                ...
                return (
                  <Card key={session.id} className="border border-slate-200 shadow-sm bg-white overflow-hidden relative">
                    ...
                    <CardContent className="p-0">
                      ...
                      >
                        <span className="text-xs font-bold text-blue-600 group-hover:text-blue-700 flex items-center">
                ...
                <div className="flex gap-2 p-1">
                  {["Bebas", "Dada", "Punggung", "Kupu"].map(gaya => (
                    <Button 
                      ...
                      className={`rounded-full h-8 px-4 text-[11px] font-bold ${selectedStroke === gaya ? 'bg-blue-600 text-white' : 'bg-white text-slate-500 border-slate-200'}`}
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100">
              <div className="flex justify-between items-center mb-4">
                ...
                <select 
                  ...
                  className="bg-slate-50 border border-slate-200 rounded-lg text-[10px] py-1 px-2 text-slate-700 font-bold focus:outline-none focus:ring-1 focus:ring-blue-500 shadow-sm"
                >
              ...
              <div className="h-48 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={chartData} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <Line type="monotone" name="Tahun Berjalan" dataKey="thisYear" stroke="#2563eb" strokeWidth={3} dot={{ r: 3, fill: "#2563eb", strokeWidth: 0 }} activeDot={{ r: 5 }} />
