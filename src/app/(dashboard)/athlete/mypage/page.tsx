      ...
      <main className="flex-1 px-4 md:px-6 lg:px-8 space-y-6 pt-5 w-full">
        ...
        <section className="flex items-center gap-4 mb-5">
          <div className="relative shrink-0">
            ...
            <div className="absolute bottom-0 right-1 h-[18px] w-[18px] bg-emerald-500 rounded-full border-[2.5px] border-white dark:border-[#161622]"></div>
          </div>
          <div>
            <p className="text-[13px] text-slate-500 dark:text-slate-400 font-medium tracking-tight mb-0.5">Salam Semangat Calon Juara!</p>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white leading-none mb-1">John Doe</h1>
        ...
        {/* ==========================================
            ...
            ========================================== */}
        <section>
          <Card className="bg-white dark:bg-[#1f1e2e] text-slate-900 dark:text-white border-slate-200 dark:border-[#2a293d] overflow-hidden relative rounded-3xl shadow-xl/30">
            <CardContent className="p-5 pb-4">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h2 className="font-bold text-lg tracking-tight mb-1 text-slate-900 dark:text-white">JADWAL HARI INI</h2>
                  <div className="flex items-center text-slate-500 dark:text-slate-400 text-[10px] mb-4">
                  ...
                  <div className="flex gap-6 mt-2">
                    <div>
                      <p className="text-[10px] font-bold text-slate-600 dark:text-slate-500 uppercase tracking-widest mb-1">Masuk</p>
                      <p className="text-2xl font-black text-slate-900 dark:text-white">{isCheckedIn ? "15:21" : "--:--"}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-slate-600 dark:text-slate-500 uppercase tracking-widest mb-1">Pulang</p>
                      {isCheckedIn ? (
                ...
                <div
                  ...
                  className="cursor-pointer bg-transparent dark:bg-[#161622] rounded-2xl p-2 -[inset_2px_2px_4px_#0d0d14,inset_-2px_-2px_4px_#1f1e2e] active:-[inset_4px_4px_8px_#0d0d14,inset_-4px_-4px_8px_#1f1e2e] transition-all border border-slate-200 dark:border-[#2a293d] shadow-xl/30"
                >
              ...
              <div className="border-t border-slate-200 dark:border-[#2a293d] pt-4 flex justify-between items-center">
                ...
                <span className={`text-[10px] font-bold tracking-widest ${isCheckedIn ? 'text-emerald-400' : 'text-slate-600 dark:text-slate-500'}`}>
              ...
              <CarouselItem className="pl-2 basis-[85%] md:basis-[60%] lg:basis-[40%]">
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Event Mendatang</p>
                  </div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white mb-1">Kejurda Jateng 2026</h4>
              ...
              <CarouselItem className="pl-2 basis-[85%] md:basis-[60%] lg:basis-[40%]">
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Update Kurikulum</p>
                  </div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white mb-1">Program V02 Max Baru</h4>
            ...
            <CardContent className="p-4 pt-3">
              ...
              <div className="grid grid-cols-3 gap-3 mb-5">
                <div className="col-span-2 bg-emerald-500/10 rounded-lg p-3 border border-emerald-500/20">
                  ...
                  <p className="text-2xl font-black text-slate-900 dark:text-white mt-1">32 <span className="text-xs font-bold text-emerald-500">Jam / Minggu</span></p>
                </div>
                <div className="bg-[#ff4b4b]/10 rounded-lg p-3 border border-[#ff4b4b]/20 flex flex-col justify-center items-center">
                  ...
                  <p className="text-xl font-black text-slate-900 dark:text-white mt-1">1x</p>
                </div>
              </div>

              {/* Tabel Mingguan */}
              <div>
                <h4 className="text-xs font-bold text-slate-900 dark:text-white mb-2 uppercase tracking-widest">Rekap Minggu Ini</h4>
                <div className="rounded-xl border border-slate-200 dark:border-[#2a293d] overflow-hidden bg-transparent dark:bg-[#161622]">
                  <Table>
                    <TableHeader className="bg-white dark:bg-[#1f1e2e]">
                      <TableRow className="border-slate-200 dark:border-[#2a293d] hover:bg-transparent">
                        <TableHead className="text-[10px] font-bold text-slate-500 dark:text-slate-400 h-8 p-3 w-[45%] uppercase tracking-widest">Tanggal</TableHead>
                        <TableHead className="text-[10px] font-bold text-slate-500 dark:text-slate-400 h-8 p-3 uppercase tracking-widest">Waktu</TableHead>
                        <TableHead className="text-[10px] font-bold text-slate-500 dark:text-slate-400 h-8 p-3 text-right uppercase tracking-widest">Status</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {weeklyAttendance.map((row, idx) => (
                        <TableRow key={idx} className="hover:bg-slate-50 dark:hover:bg-[#1f1e2e] border-slate-200 dark:border-[#2a293d]">
                          <TableCell className="text-[11px] font-bold p-3 text-slate-900 dark:text-white">{row.date}</TableCell>
                          <TableCell className="text-[11px] text-slate-500 dark:text-slate-400 p-3 font-mono">{row.time}</TableCell>
                              ...
                              className={`text-[9px] px-1.5 py-0.5 border-none font-bold whitespace-nowrap uppercase tracking-widest ${row.status === "Hadir" ? "bg-emerald-500/20 text-emerald-400" :
                                row.status === "Terlambat" ? "bg-[#ff4b4b]/20 text-[#ff4b4b]" :
                                  row.status === "Dinas Luar" ? "bg-blue-500/20 text-blue-400" : // Dinas = aktif
                                    "bg-slate-100 dark:bg-[#2a293d] text-slate-500 dark:text-slate-400"
                                }`}
                            >
