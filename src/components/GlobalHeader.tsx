    ...
    return (
      <>
        ...
        <header className={`sticky top-0 z-40 w-full flex h-14 items-center gap-3 px-4 transition-all duration-300 ${
          ...
          <h1 className="font-bold text-white text-lg uppercase tracking-widest truncate">{title}</h1>
        </header>
      </>
    )
  }
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[280px] bg-[#1f1e2e] border-[#2a293d] text-white p-0 flex flex-col h-full border-r">
              ...
              <div className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <Button variant="ghost" className="w-full justify-start text-slate-300 hover:text-white hover:bg-[#2a293d] h-11 px-3 rounded-xl transition-all">
                  <Activity className="mr-3 h-5 w-5 text-amber-400" />
              ...
              <div className="p-4 border-t border-[#2a293d] space-y-4 shrink-0 bg-[#161622]">
                ...
                <div className="flex items-center justify-between bg-[#1f1e2e] p-1.5 rounded-xl border border-[#2a293d]">
                  ...
                  <Button variant="ghost" className="flex-1 h-8 rounded-lg bg-[#2a293d] text-white shadow-sm font-bold text-xs">
                ...
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-[#2a293d] border-2 border-[#ff4b4b] shrink-0 overflow-hidden">
                    <img src="https://i.pravatar.cc/150?u=johndoe" alt="Profile" className="h-full w-full object-cover" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-bold text-white truncate tracking-wide">John Doe</p>
                    <p className="text-[10px] text-slate-400 font-medium truncate">Head Coach</p>
                  </div>
                  <Button variant="ghost" size="icon" className="h-8 w-8 text-slate-400 hover:text-[#ff4b4b] hover:bg-[#ff4b4b]/10 rounded-lg shrink-0 transition-colors">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[350px] bg-[#1f1e2e] border-[#2a293d] p-0 flex flex-col h-full border-l text-white">
              <SheetHeader className="p-4 border-b border-[#2a293d] bg-[#161622] text-left">
                <SheetTitle className="text-white font-bold text-xs uppercase tracking-widest">Pencarian</SheetTitle>
              </SheetHeader>
              <div className="p-4 flex-1">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  <Badge variant="outline" className="bg-[#2a293d] text-slate-300 border-[#34334a] hover:bg-[#34334a] cursor-pointer">Bima Arya</Badge>
                  <Badge variant="outline" className="bg-[#2a293d] text-slate-300 border-[#34334a] hover:bg-[#34334a] cursor-pointer">Time Trial 50M</Badge>
                </div>
              </div>
            </SheetContent>
          </Sheet>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[320px] sm:w-[350px] bg-[#1f1e2e] border-[#2a293d] p-0 flex flex-col h-full border-l text-white">
              <SheetHeader className="p-4 border-b border-[#2a293d] bg-[#161622] text-left flex flex-row items-center justify-between">
                <SheetTitle className="text-white font-bold text-xs uppercase tracking-widest flex items-center gap-2">
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="p-4 border-b border-[#2a293d] hover:bg-[#2a293d] transition-colors cursor-pointer relative overflow-hidden">
                  ...
                  <div className="pl-3">
                    <p className="text-sm font-bold text-white mb-1">Pengumuman: Kejurda 2026</p>
                    <p className="text-xs text-slate-400 line-clamp-2 mb-2">Siapkan atlet lapis 1 untuk kualifikasi gaya bebas & ganti. Pendaftaran ditutup 10 Juli.</p>
                ...
                <div className="p-4 border-b border-[#2a293d] hover:bg-[#2a293d] transition-colors cursor-pointer relative overflow-hidden">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#ff4b4b]" />
                  <div className="pl-3">
                    <p className="text-sm font-bold text-white mb-1">Jadwal Latihan Diubah</p>
                    <p className="text-xs text-slate-400 line-clamp-2 mb-2">Sesi Latihan Sore (Elite) diubah lokasinya ke UNY Pool karena pemeliharaan.</p>
                ...
                <div className="p-4 hover:bg-[#2a293d] transition-colors cursor-pointer">
                  <div className="pl-3">
                    ...
                    <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Kemarin</span>
                  </div>
                </div>
              </div>
